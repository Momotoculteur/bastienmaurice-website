...
2. Les Conteneurs :
   - Images avec packages obsolètes ou en mode root
...
**Log4Shell** : Un incident majeur qui montre qu'une simple dépendance peut mettre à terre toute une infrastructure 🤯
